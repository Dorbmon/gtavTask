...
namespace GTA
{
	internal class mission_npc_follow4 : mission
	{
		...
		public override void load()
		{
			...
			spot1 = World.CreatePed(PedHash.Abigail, spotPos1);
			endtarget = World.CreatePed(PedHash.AfriAmer01AMM, shelterPos);
			if (npc == null)
			{
		...
		private void OnTick_case(object sender, EventArgs e)
		{
			...
			switch (curState)
			{
				...
				case MissionState.WalkToShelter:
					...
					if (Vector3.Distance(npc.Position, shelterPos) < 3.0f)
					{
